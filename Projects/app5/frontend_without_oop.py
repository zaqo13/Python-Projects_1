...
def view_command():
    list1.delete(0,END) #deleting everything starting from 0 to END!
    for row in backend.view():
        list1.insert(END,row)   #go to the end an insert row! i.e. data will insert as it present to it
